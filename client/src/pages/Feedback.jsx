...
export default function Feedback() {
  ...
  return (
    <div className="max-w-3xl mx-auto flex flex-col gap-8 animate-in fade-in slide-in-from-bottom-8 duration-500 pt-8">
      <div className="bg-slate-900/60 backdrop-blur-3xl p-8 sm:p-10 rounded-3xl border border-white/10 shadow-2xl relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          {submitted ? (
            <div className="bg-indigo-500/10 border border-indigo-500/30 text-indigo-300 p-6 rounded-2xl flex flex-col items-center justify-center gap-4 text-center animate-in zoom-in-95 duration-300">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-6">
              <div>
                <textarea
                  ...
                  className="w-full bg-white/5 border border-white/10 text-white rounded-2xl p-5 min-h-[160px] focus:outline-none focus:border-indigo-500 focus:bg-white/10 transition-all font-medium placeholder-gray-500 resize-y shadow-inner"
                  required
                  disabled={submitting}
                />
              </div>
              <div className="flex justify-end">
                <button
                  ...
                  className="flex items-center gap-2 bg-indigo-600 hover:bg-indigo-500 disabled:opacity-50 disabled:hover:bg-indigo-600 text-white px-6 py-3 rounded-xl font-semibold transition-all shadow-lg shadow-indigo-500/20"
                >
                  {submitting ? 'Sending...' : (
                    <>
